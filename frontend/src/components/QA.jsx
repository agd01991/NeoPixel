...
<div class="max-w-xl mx-auto">
  <details class=" open:ring-1 open:ring-black/5 dark:open:ring-white/10 p-6 rounded-lg" close>
    ...
    <ul className='sf w-full font-normal'>
                        ...
                        <li>Возможно образование эффекта присоски, когда модель слишком сильно прилипает к пленка, создавая вакум, что срывает ее с платформы</li>
                        </ul>
...
<div className='uppercase text-lg w-[275px] laptop:w-[1400px] text-white/25 laptop:text-2xl mx-auto'>
